...
- [ ] 7.1 Confirm `v3.3.16-nes.patch.1` does not already exist locally or remotely and the target release commit SHA is unchanged.
- [ ] 7.2 Create annotated tag `v3.3.16-nes.patch.1` on the exact release commit only after `nexus-verified`.
